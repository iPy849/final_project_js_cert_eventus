<template>
    ...
    <!-- Contacto -->
    <section class="bg-primary flex flex-col md:flex-row justify-between items-center gap-4 text-dark" id="contact">
        <div class="flex flex-col">
            <a href="mailto:example@example.com"><b>Correo:</b> example@example.com</a>
